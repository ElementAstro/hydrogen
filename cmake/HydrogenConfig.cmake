...
option(HYDROGEN_ENABLE_BASE64 "Enable base64 encoding support (legacy)" OFF)
...
function(hydrogen_configure_features)
    ...
    # Base64 Feature (Legacy)
    if(HYDROGEN_ENABLE_BASE64)
        set(HYDROGEN_HAS_BASE64 TRUE CACHE BOOL "Base64 encoding support available")
        message(STATUS "Hydrogen: Base64 encoding support enabled (legacy)")
    else()
        set(HYDROGEN_HAS_BASE64 FALSE CACHE BOOL "Base64 encoding support available")
        message(STATUS "Hydrogen: Base64 encoding support disabled")
    endif()
...
function(hydrogen_print_configuration_summary)
    ...
    message(STATUS "  Base64 support: ${HYDROGEN_ENABLE_BASE64}")
    message(STATUS "  Logging: ${HYDROGEN_ENABLE_LOGGING}")
    message(STATUS "")
