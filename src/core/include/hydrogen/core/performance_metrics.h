...
public:
   ...
   */
  virtual void recordMetric(const std::string &deviceId, MetricType metricType,
  ...
  getStatistics(const std::string &deviceId, MetricType metricType,
   ...
   */
  virtual PerformanceTrend analyzeTrend(
      const std::string &deviceId, MetricType metricType,
   ...
   */
  virtual void registerAlert(const std::string &deviceId,
                             const PerformanceAlert &alert) = 0;
   ...
   */
  virtual void removeAlert(const std::string &deviceId,
                           const std::string &alertName) = 0;
   ...
   */
  virtual bool exportMetrics(const std::string &filename,
...
public:
  ...
  void recordMetric(const std::string &deviceId, MetricType metricType,
                    const std::string &name, double value,
  ...
  void registerAlert(const std::string &deviceId,
                     const PerformanceAlert &alert) override;
  void removeAlert(const std::string &deviceId,
                   const std::string &alertName) override;
  ...
  bool exportMetrics(const std::string &filename,
                     const std::string &format = "json") const override;
...
private:
  ...
  std::unordered_map<std::string, std::unordered_map<std::string, MetricData>>
      deviceMetrics_;
  ...
  // Helper methods
  void calculateStatistics(const std::string &deviceId,
