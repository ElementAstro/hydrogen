...
public:
  ...
  getEstimatedMoveTime(int position) const = 0;
...
public:
   ...
   */
  virtual void setWeatherUpdateCallback(
      std::function<void(const WeatherData &)> callback) = 0;
...
public:
   ...
   */
  enum class ShutterState { CLOSED, OPENING, OPEN, CLOSING, ERROR, UNKNOWN };
