...
public:
    ...
    FifoConfig mergeConfigs(const FifoConfig& base, const FifoConfig& override) const;
    ...
    FifoConfig createPlatformOptimizedConfig(ConfigPreset preset = ConfigPreset::DEFAULT) const;
    ...
    json compareConfigs(const FifoConfig& config1, const FifoConfig& config2) const;
    std::vector<std::string> getConfigDifferences(const FifoConfig& config1, const FifoConfig& config2) const;
