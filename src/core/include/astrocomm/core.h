...
/**
 * @file core.h
 * @brief Main header for AstroComm Core component
 * 
...
/**
 * @namespace astrocomm::core
 * @brief Core functionality namespace for AstroComm library
 * 
 * This namespace contains all the fundamental components that are shared
 * across the AstroComm library, including message handling, utilities,
