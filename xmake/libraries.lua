...
target("hydrogen_core")
    ...
    -- Source files (updated to match actual file structure)
    add_files("../src/core/src/infrastructure/core.cpp")
    add_files("../src/core/src/infrastructure/utils.cpp")
    add_files("../src/core/src/infrastructure/error_recovery.cpp")
    add_files("../src/core/src/infrastructure/discovery.cpp")
    add_files("../src/core/src/infrastructure/performance_metrics.cpp")
    add_files("../src/core/src/messaging/message.cpp")
    add_files("../src/core/src/messaging/message_queue.cpp")
    add_files("../src/core/src/messaging/message_transformer.cpp")
    add_files("../src/core/src/messaging/message_validator.cpp")
    add_files("../src/core/src/device/device_interface.cpp")
    add_files("../src/core/src/device/device_health.cpp")
    add_files("../src/core/src/device/device_lifecycle.cpp")
    add_files("../src/core/src/device/device_plugin.cpp")
    add_files("../src/core/src/configuration/client_configuration.cpp")
    add_files("../src/core/src/configuration/stdio_config_manager.cpp")
    add_files("../src/core/src/configuration/fifo_config_manager.cpp")
    add_files("../src/core/src/logging/stdio_logger.cpp")
    add_files("../src/core/src/logging/fifo_logger.cpp")
    add_files("../src/core/src/communication/infrastructure/protocol_communicator_factory.cpp")
    add_files("../src/core/src/communication/protocols/stdio_communicator.cpp")
    add_files("../src/core/src/communication/protocols/fifo_communicator.cpp")
    add_files("../src/core/src/communication/protocols/enhanced_tcp_communicator.cpp")
    add_files("../src/core/src/performance/connection_pool.cpp")
    add_files("../src/core/src/performance/memory_pool.cpp")
    add_files("../src/core/src/performance/message_batcher.cpp")
    add_files("../src/core/src/performance/serialization_optimizer.cpp")
    add_files("../src/core/src/performance/tcp_connection.cpp")
...
target("hydrogen_server")
    ...
    add_files("../src/server/src/services/device_monitoring_service_impl.cpp")
    ...
    add_files("../src/server/src/protocols/stdio/stdio_server.cpp")
    add_files("../src/server/src/protocols/fifo/fifo_server.cpp")
    add_files("../src/server/src/protocols/fifo/fifo_protocol_handler.cpp")
