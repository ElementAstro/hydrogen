...
/**
 * @file device.h
 * @brief Main header for Hydrogen Device component
 * 
...
// Main device implementations (from src/device/)
#include "../../../device/camera.h"
#include "../../../device/focuser.h"

/**
 * @namespace hydrogen::device
 * @brief Device functionality namespace for Hydrogen library
 * 
